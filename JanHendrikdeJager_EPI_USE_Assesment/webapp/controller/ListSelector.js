sap.ui.define([
	...
	return BaseObject.extend("epi.use.training.EPI-USE_Training_StudentMarks.controller.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias epi.use.training.EPI-USE_Training_StudentMarks.controller.ListSelector
		 */
